...
const episodes = [
{
    id: "ep076",
    size: 1639032,
    title: "EP076 - AI双雄IPO军备竞赛",
    date: "2026-06-28",
    description: "OpenAI 和 Anthropic 同月提交 IPO，AI 行业进入万亿估值公共市场时代。两大 AI 巨头跑步上市，谁在定义人类未来？",
    audioUrl: "/episodes/ep076.mp3",
    cover: "https://daikexing.work/episodes/covers/ai_076.jpg",
    duration: "04:33",
    shownotes: "\n" + '本期主題：OpenAI 和 Anthropic 同月提交 IPO，標誌 AI 行業進入萬億估值公共市場時代\n金句鉤子：「兩家燒錢速度極快的公司，以近萬億美元的估值登陸二級市場，這件事本身就需要每一個投資者認真思考。」\n完整摘要（3句）：\n- OpenAI 和 Anthropic 在 2026 年 6 月相繼提交 IPO 申請，這是 AI 行業歷史性的資本化時刻\n- 兩家公司估值均接近或超過萬億美元，但均未盈利，上市是為獲取更大算力投入所需的資金\n- 業內人士已在減持，普通投資者在入場，這種錯位值得警惕\nTimeline（可選）：\n- [2026年5月] Anthropic 完成 650 億美元私募輪，估值 9650 億\n- [2026年5月5日] OpenAI 發布 GPT-5.5，設為 ChatGPT 默認模型\n- [2026年5月28日] Anthropic 發布 Claude Opus 4.8，多項基準全球第一\n- [2026年6月] OpenAI 和 Anthropic 相繼提交 IPO 申請\n- [2026年6月2-3日] 微軟 Build 2026 發布 7 款自研 MAI 模型\n核心要點（5+ 條）：\n- Anthropic 和 OpenAI 同月提交 IPO，AI 行業進入公共市場時代\n- Anthropic 最新估值 9650 億美元，年化收入達 470 億美元但仍虧損\n- Claude Opus 4.8 首個 ScienceQA 突破 75 分，編程能力超 GPT-5.5\n- Claude Code 年化收入 63 億美元，拿下 AI 編程市場 54% 份額\n- Anthropic 公開呼籲放緩 AI 研發，理由是 2028 年有 60% 概率實現 AI 自進化\n- OpenAI 同步提交 IPO 申請，矽谷 AI 軍備競賽轉向二級市場\n- 微軟 Build 2026 發布 7 款自研 MAI 模型，戰略擺脫 OpenAI 依賴\n- 機構過去六個月賣出 13 次買入 0 次，內部人士已在撤離\n- 中國軍團：DeepSeek V4 成本 GPT-5 的 1/30，MiniMax 啟動 IPO\n- AI 正在從私募市場轉向公共市場，散戶將首次直接參與 AI 萬億軍備競賽'
  },

{
    id: "ep075",
    size: 6509916,
    title: "EP075 - 万台机器人背后：具身智能如何从PPT走向月产1亿？",
    date: "2026-06-27",
    description: "你有没有注意到一个信号？具身智能，正在穿越从技术到商业的生死线。上周，智身科技宣布了一个数字：第10000台具身智能机器人量产下线。5个月前，这个数字是5000台。翻倍的速度，超出了几乎所有人的预期。更重要的是：单月产值突破了1亿元。这意味着什么？意味着这家公司的具身智能，已经不是PPT，不是概念验证，是真正卖得出去、卖得出量、卖得出价的产品。",
    audioUrl: "/episodes/ep075.mp3",
    cover: "https://daikexing.work/episodes/covers/ai_075.jpg",
    duration: "06:46",
    shownotes: "\n" + '🎙️ 本期主题：具身智能万台量产背后的商业化突围战\n金句钩子：「万台量产只是开始，中国具身智能正在穿越从技术到商业的生死线。」\n完整摘要（3句）：\n- 智身科技实现第10000台具身智能机器人量产，5个月内从5000台翻倍至万台，单月产值突破1亿元\n- 具身智能行业标准正式实施，标志行业从野蛮生长进入有序竞争，淘汰赛加速\n- 大模型赋能具身智能"大脑"，端侧AI芯片突破算力瓶颈，AI机器人赛道正在从"能不能做"切换到"怎么做大"\nTimeline（可选）：\n- [6月1日] 智身科技万台具身智能机器人量产下线\n- [6月1日] 《具身智能基准测试方法》行业标准正式实施\n- [近期] 智元机器人发布BFM-2运动基座模型\n- [三季度] WITA Omni 1.0计划发布\n核心要点（5+ 条）：\n- 具身智能从5000台到10000台仅用5个月，量产速度超预期\n- 单月产值突破1亿元，证明商业化闭环初步形成\n- 行业标准落地是具身智能从技术到产业化的关键里程碑\n- 生成式训练机制让机器人从"动作复刻"进化到"运动思考"\n- 具身智能是端侧AI最重要的应用场景之一\n- 中国制造业基础和超大市场规模是具身智能发展的独特优势\n- 具身智能赛道正从"技术驱动"转向"商业驱动"，投资逻辑生变\n虾闯天下 · AI 科技创业日更'
  },
